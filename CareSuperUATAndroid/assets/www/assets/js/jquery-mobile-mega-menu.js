		...
		mobileMegaMenu: function(options){
			...
			return this.each(function() {
				...
				var animationSpeed 	= 250, // Change SCSS to match this speed
					nextButton 		= '<a class="next-button" href="#"><i class="evo-icon-arrow-right2 evo-icon-size-medium"></i></a>',
...
/* ------------------------- Actions ------------------------- */
 ...
 $("#bckBtn").css("display", "none");
 setTimeout(function(){$("body").css("background-color","#2158F5")},200);
 ...
 $("#bckBtn").css("display", "inline-block");
 setTimeout(function(){$("body").css("background-color","#C8FFE4")},100);
 $backAction.parents('ul.is-in-view').closest('ul.has-been-viewed').toggleClass('has-been-viewed is-in-view').promise().done(function(){
 ...
 $menuRoot.find('ul.is-in-view ul.is-in-view').toggleClass('is-in-view');
				...
				$(".has-next-button").click(function(event){
					event.preventDefault();
