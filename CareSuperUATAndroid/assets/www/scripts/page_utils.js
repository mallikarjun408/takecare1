    ...
    if ((hrefOrigin != "file://") && (hrefOrigin != "tel://") && (hrefOrigin != "sms://")
        ...
        if (devicePlatform == "Android") {
            ...
            if ((fileExtension === "pdf") || (fileExtension === "PDF")) {
                ...
                hrefValue = "http://docs.google.com/viewer?url="+hrefValue;
            } if( (hrefValue.indexOf('register') !== -1)  || (hrefValue.indexOf('simplified-login-faq') !== -1)){
             browserTarget = '_system';
            } else {
       ...
       // window.open(hrefValue,browserTarget,option)
...
function moveToChangePasswordScreen() {
    localStorage.setItem('userNavigatefrom', 'hamburgerpage');
    document.location.href= "../html/enter_4_digit_pin-quick_pin_setup.html";
}

function moveTo4digitPinsetupScreen() {
