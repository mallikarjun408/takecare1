	...
	window.plugins.touchid.verifyFingerprintWithCustomPasswordFallbackAndEnterPasswordLabel(
		...
		function (msg) {
			...
			if (accessMesg == "Scan your Face ID please")
				$("#message-to-display").html("Invalid authentication/Face ID max attempts reached");
			else
				$("#message-to-display").html("Invalid authentication/Touch ID max attempts reached");
			$("#alert-dialog").foundation("open");
