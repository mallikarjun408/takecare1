...
//                   url: "https://uat.services.mercerfinancialservices.com/v1/customer",
                ...
                success: function (data) {
                    ...
                    if (data && data.givenNames && data.surname) {
                        ...
                        $("#logged-in-user-details").css("margin-top", "30px");
                        $("#logged-in-user-details").html("There was an error loading the details.<br>Please close app and try again.<br>If the problem persists call us on<br><a href='tel:1800652525'>1800 652 525</a>");
                    }
